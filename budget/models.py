...
class PlannedExpense(models.Model):
    ...
    priority = models.CharField(max_length=20, choices=PRIORITY_CHOICES, default='medium', blank=True, verbose_name="Priorytet")
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='planned', blank=True, verbose_name="Status")
